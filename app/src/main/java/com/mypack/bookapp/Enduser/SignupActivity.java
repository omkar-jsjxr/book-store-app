...
import com.mypack.bookapp.Admin.AdminsignupgotoActivity;
...
public class SignupActivity extends AppCompatActivity {
    ...
    private Button signupbtn,gotoadminsignup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoadminsignup=(Button)findViewById(R.id.goto_admin_signup);
        ...
        gotoadminsignup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SignupActivity.this, AdminsignupgotoActivity.class);
    ...
    Rootref.addListenerForSingleValueEvent(new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            if (!(snapshot.child("Users").child(phone_no).exists())) {
                ...
                userdatamap.put("Phone",phone_no);
